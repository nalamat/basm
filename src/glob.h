...
#ifndef __BASM_GLOBALS_H__
#define __BASM_GLOBALS_H__

#include <string>

using namespace std;

extern string glob_app_shortname;
extern string glob_app_fullname;
extern string glob_app_version;
extern string glob_app_email;
extern string glob_app_web;
